...
------------------------------------------------------------------------------------------------------------------------------------------
Instructions:
- Drag and drop the TSMS folder into Netbeans. For Eclipse go to open project from file system.
- Open and run XAMPP and start the Apache and SQL modules.
- Import the " tsms_projectdb.sql " database into XAMPP.
- Run the project. If prompted to select a main class select LoginForm.java
