...
------------------------------------------------------------------------------------------------------------------------------------------
Instructions:
- Download and run the executable/installer and choose a location to extract application to.
(Do not modify or move the lib folder that is inside, it contains the necessary JDK)
